...
@section('content')
    <div class="h-[72.7vh] flex items-center justify-center bg-neutral-700 text-white">
        <form action="/admin_users_edit/{{ $user->id }}" method="post" class="flex flex-col items-center">
            @method('patch')
            @csrf
            <table>
                ...
                <tr class="mb-3 flex justify-between gap-10 items-center">
                    <td>
                        <label for="is_vip" class="form-label text-xl">VIP</label>
                    </td>
                    <td>
                        <input type="text" name="is_vip" id="is_vip" class="w-[500px] form-control bg-neutral-700"
                            value="{{ $user->is_vip }}">
                    </td>
                </tr>
                <tr class="mb-3 flex justify-between gap-10 items-center">
                    <td>
                        <label for="is_admin" class="form-label text-xl">ADMIN</label>
                    </td>
                    <td>
